function Tri = triTriangulate(Pos,Vertex)

% function Tri = triTriangulate(Pos,Slices)
%
...
fprintf(1,'Starting triangulation process\n');
...
% Skip this one since we are not doing any closed surfaces now

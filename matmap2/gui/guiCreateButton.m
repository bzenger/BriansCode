function Handle = guiCreateButton(varargin)

% FUNCTION handle = guiCreateButton([figurehandle],string,callback,position)
%
% DESCRIPTION
...
global GUI;
Button = GUI.Template.PushButton; % Obtain the template
...
Button.Position = guiTranslatePosition(varargin{k+2},0); % make a small border surrounding button
